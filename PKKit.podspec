#
#  Be sure to run `pod spec lint PKKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Patrick"
  # s.authors            = { "Patrick" => "498615180@qq.com" }
  # s.social_media_url   = "http://twitter.com/Patrick"
  ...
  s.source       = { :git => "https://github.com/PatrickWP/PKKit.git", :tag => "0.0.2" }
